...
void save_config(const Config& config) {
    ...
    out << "# drop-zone client configuration.\n"
        ...
        << "# The private password is never stored -- it only unlocks identity.key -- and\n"
        << "# neither is the public password, which is the one you hand to people sending\n"
        << "# you files.\n"
        << "\n"
        << "[identity]\n"
        ...
        << "\n"
        << "[transfers]\n"
        << "# Where received files go when `drop-zone accept` is given no -o. Empty means\n"
