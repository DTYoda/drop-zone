...
// private half under the private password. Nothing else on the machine needs
// that password, and it never crosses the network in any form.
//
...
/// Generate a new identity and write it sealed under `private_password`.
